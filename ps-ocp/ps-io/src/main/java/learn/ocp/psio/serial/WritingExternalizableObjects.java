...
public class WritingExternalizableObjects {
    ...
    public static void main(String[] args) {
        ...
        PersonExternalizable p1 = new PersonExternalizable("Linda", 32);
        PersonExternalizable p2 = new PersonExternalizable("David", 27);
